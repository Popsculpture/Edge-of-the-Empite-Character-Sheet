...
window.SW.talents = [
  ...
  },
  {
    ...
    "ranked": false,
    "activation": "Passive",
    "description": "While wearing armor, the character increases their total soak value by one."
  },
  {
    "key": "ARMIMP",
  ...
  },
  {
    ...
    "ranked": false,
    "activation": "Action",
    "description": "Once per game session, the character may take a Bad Motivator action to make a Hard difficulty Mechanics check. If successful, one device (subject to the GM's approval) spontaneously fails due to the character's involvement, or because it was about to fail anyway and the character noticed it (this is the character's decision)."
  },
  {
    "key": "BADPRESS",
    "name": "Bad Press",
  ...
  },
  {
    ...
    "ranked": true,
    "activation": "Passive",
    "description": "The character removes a setback die per rank of Bypass Security from [their] Skulduggery and Computers skill checks made to disable a security device or open a locked door."
  },
  {
    "key": "CALLEM",
    "name": "Call 'Em",
  ...
  },
  {
    ...
    "ranked": true,
    "activation": "Passive",
    "description": "The character removes a setback die per rank of Convincing Demeanor from [their] Deception and Skulduggery checks."
  },
  {
    "key": "COORDASS",
  ...
  },
  {
    ...
    "ranked": false,
    "activation": "Passive",
    "description": "The character reduces the critical rating of all improvised weapons [they are] wielding by 2 (to a minimum of 1)."
  },
  {
    "key": "CRIPV",
    "name": "Crippling Blow",
  ...
  },
  {
    ...
    "ranked": false,
    "activation": "Incidental",
    "description": "The character may spend one Destiny Point to add additional damage equal to half [their] Agility rating (rounded up) to one hit of a successful attack made by ship or vehicle-mounted weaponry."
  },
  {
    "key": "DEADIMP",
  ...
  },
  {
    ...
    "ranked": true,
    "activation": "Passive",
    "description": "Any vehicle the character pilots has its defensive rating on all zones increased by one per rank of Defensive Driving."
  },
  {
    "key": "DEFSLI",
    ...
    "ranked": true,
    "activation": "Passive",
    "description": "When attempting to defend a computer system against intrusion (or when an opponent attempts to slice a computer owned or programmed by the character), the character adds a setback die per rank of Defensive Slicing to [their] opponent's checks."
  },
  {
    "key": "DEFSLIIMP",
  ...
  },
  {
    ...
    "ranked": true,
    "activation": "Passive",
    "description": "The character removes a setback dice per rank of Expert Tracker from [their] checks to find or follow tracks. Survival checks made to track targets take 50% less time than normal (this does not decrease with additional ranks of Expert Tracker)."
  },
  {
    "key": "EXTENDEDREAC",
    "name": "Extended Reach",
  ...
  },
  {
    ...
    "ranked": true,
    "activation": "Passive",
    "description": "The character adds 1 damage per rank of Feral Strength to one hit of [their] successful Brawl and Melee attacks."
  },
  {
    "key": "FLDCOMM",
  ...
  },
  {
    ...
    "ranked": true,
    "activation": "Passive",
    "description": "Whenever the character repairs system strain on a starship or vehicle, [they] repair one additional system strain per rank of Fine Tuning."
  },
  {
    "key": "FIRECON",
    "name": "Fire Control",
  ...
  },
  {
    ...
    "ranked": false,
    "activation": "Maneuver",
    "description": "When piloting a ship or vehicle, the character may take the Full Stop maneuver to immediately reduce the speed of the ship or vehicle to zero. The ship or vehicle then suffers one point of system strain for every point of speed it had before stopping."
  },
  {
    "key": "FULLTH",
    "name": "Full Throttle",
  ...
  },
  {
    ...
    "ranked": false,
    "activation": "Incidental",
    "description": "When making a combined combat check with two Ranged (Light) weapons, the character may suffer 2 strain in order to refrain from increasing the difficulty of the check for attacking with two weapons."
  },
  {
    "key": "HARASS",
    "name": "Harass",
  ...
  },
  {
    ...
    "ranked": true,
    "activation": "Action",
    "description": "On any turn in which the character is staggered or disoriented, they may perform the Hard Headed action (even though staggered characters are normally barred from performing actions). The character makes a Daunting difficulty Discipline check. If they succeed, they are no longer staggered or disoriented. The difficulty of this check decreases by one per additional rank of Hard Headed, to a minimum of Easy difficulty."
  },
  {
    "key": "HARDHDIMP",
  ...
  },
  {
    ...
    "ranked": false,
    "activation": "Passive",
    "description": "Allies within short range of the character add a boost die to their Perception and Vigilance checks. Allies engaged with [them] add two boost dice instead. While the Force and Destiny Roleplaying Game: Core Rulebook shows this as \"Ranked: Yes\", the Errata (Page 1) corrects this to \"Ranked: No\"."
  },
  {
    "key": "HERO",
  ...
  },
  {
    ...
    "ranked": true,
    "activation": "Passive",
    "description": "The character adds a boost die per rank of Hunter to all skill checks when interacting with wild beasts and animals, including combat checks. The character adds +10 per rank of Hunter to all of [their] Critical Injury rolls against animals."
  },
  {
    "key": "HUNTERQUARRY",
  ...
  },
  {
    ...
    "ranked": false,
    "activation": "Action",
    "description": "The character may take the Inspiring Rhetoric action; making an Average difficulty Leadership check. For each success [result], one ally within close range recovers one strain. For each advantage [result], one ally benefiting from Inspiring Rhetoric recovers one additional strain."
  },
  {
    "key": "INSPRHETIMP",
  ...
  },
  {
    ...
    "ranked": true,
    "activation": "Passive",
    "description": "The character removes a setback die per rank of Kill with Kindness from [their] Charm and Leadership checks."
  },
  {
    "key": "KNOCK",
    "name": "Knockdown",
    "ranked": false,
    "activation": "Passive",
    "description": "After hitting with a melee attack, the character may knock the target prone by spending a triumph result. If the target is larger than the acting character, it requires one additional triumph for each silhouette larger."
  },
  {
    "key": "KNOWSOM",
    "name": "Know Somebody",
  ...
  },
  {
    ...
    "ranked": false,
    "activation": "Incidental",
    "description": "Once per round on the character's turn, the character may mount or dismount from a vehicle or beast, or slide into the cockpit or weapon station aboard a starship, as an incidental instead of a maneuver."
  },
  {
    "key": "LETHALBL",
    "name": "Lethal Blows",
  ...
  },
  {
    ...
    "ranked": true,
    "activation": "Passive",
    "description": "When this character makes a Mechanics check to help a character heal wounds, the target heals one additional wound per rank of Machine Mender. (Typically, only droids can be healed with Mechanics check.)"
  },
  {
    "key": "MADEYOUTALK",
    "name": "Made You Talk",
  ...
  },
  {
    ...
    "ranked": false,
    "activation": "Incidental",
    "description": "Once per round, the character may suffer two strain to decrease the difficulty of [their] next Medicine check by one to a minimum of Easy difficulty."
  },
  {
    "key": "MASDRIV",
    "name": "Master Driver",
    "ranked": false,
    "activation": "Incidental",
    "description": "Once per round when piloting a vehicle using the Piloting (Planetary) skill, the character may voluntarily suffer two strain to perform any action as a maneuver instead."
  },
  {
    "key": "MASGREN",
  ...
  },
  {
    ...
    "ranked": false,
    "activation": "Incidental",
    "description": "Once per round when piloting a starship (a ship piloted using the Piloting [Space] skill), the character may voluntarily suffer two strain to perform any action as a maneuver instead."
  },
  {
    "key": "MASSLIC",
    "name": "Master Slicer",
    "ranked": false,
    "activation": "Incidental",
    "description": "Once per round, the character may perform a Master Slicer incidental to suffer two strain and decrease the difficulty of the next Computers or other slicing-related check by one, to a minimum of Easy difficulty."
  },
  {
    "key": "MASSTAR",
  ...
  },
  {
    ...
    "ranked": true,
    "activation": "Passive",
    "description": "Each rank of More Machine than Man increases the character's cybernetic implant cap by 1."
  },
  {
    "key": "MOSTIMPRESSI",
  ...
  },
  {
    ...
    "ranked": false,
    "activation": "Incidental",
    "description": "Once per game session, the character may reroll any one Medicine check."
  },
  {
    "key": "NATDRIV",
    "name": "Natural Driver",
    "ranked": false,
    "activation": "Incidental",
    "description": "Once per game session, the character may reroll any one Piloting (Planetary) or Gunnery check."
  },
  {
    "key": "NATENF",
    ...
    "ranked": false,
    "activation": "Incidental",
    "description": "Once per game session, the character may reroll any one Coercion or Streetwise check."
  },
  {
    "key": "NATHUN",
    "name": "Natural Hunter",
  ...
  },
  {
    ...
    "ranked": false,
    "activation": "Incidental",
    "description": "Once per game session, the character may reroll any one Piloting (Space) or Gunnery check."
  },
  {
    "key": "NATPRO",
  ...
  },
  {
    ...
    "ranked": false,
    "activation": "Incidental",
    "description": "Once per game session, the character may reroll any one Skulduggery or Stealth check."
  },
  {
    "key": "NATSCH",
    ...
    "ranked": false,
    "activation": "Incidental",
    "description": "Once per game session, the character may reroll any one Knowledge skill check."
  },
  {
    "key": "NATTIN",
  ...
  },
  {
    ...
    "ranked": false,
    "activation": "Passive",
    "description": "After making one or more successful combat checks against a target, the character adds a boost die to combat checks against that same target for the remainder of the encounter."
  },
  {
    "key": "PHYSTRAIN",
  ...
  },
  {
    ...
    "ranked": false,
    "activation": "Incidental",
    "description": "Force talent. Once per game session, the character may remove two setback dice from any one skill check."
  },
  {
    "key": "SENSDEMO",
    "name": "Sense Emotions",
  ...
  },
  {
    ...
    "ranked": false,
    "activation": "Passive",
    "description": "When in a starship or vehicle with functional coms, allies within short range add a boost die to their Perception and Vigilance checks. Allies within close range add two boost dice instead. This talent operates on planetary scale, not personal scale."
  },
  {
    "key": "SIXSENSE",
    "name": "Sixth Sense",
  ...
  },
  {
    ...
    "ranked": true,
    "activation": "Passive",
    "description": "At the beginning of each game session, the character gains credits equal to [their] ranks in Sound Investments times 100. How this money is earned is up to the player and GM, and could be actual investments, business dealings, or even a small legal or illegal side business. The GM can also decide that the current events of the adventure may make these funds unavailable."
  },
  {
    "key": "SPARECL",
    "name": "Spare Clip",
    "ranked": false,
    "activation": "Passive",
    "description": "The character does not run out of ammo on a despair result. Items with Limited Ammo quality run out of ammo as normal."
  },
  {
    "key": "SPKBIN",
    "name": "Speaks Binary",
  ...
  },
  {
    ...
    "ranked": true,
    "activation": "Passive",
    "description": "The character removes a setback die per rank of Steady Nerves from Cool or Skulduggery checks."
  },
  {
    "key": "STNERV",
    "name": "Steely Nerves",
  ...
  },
  {
    ...
    "ranked": false,
    "activation": "Action",
    "description": "The character may take the Stim Application action. To perform this action, they must have access to drugs, a medpac, or stimpacks. They make an Average difficulty Medicine check. If successful, one ally they are engaged with (including themselves) increases one characteristic of the character's choice by one for the remainder of the encounter, and suffers four strain. A single character's individual characteristics may each only be increased once by Stim Application during an encounter."
  },
  {
    "key": "STIMAPIMP",
  ...
  },
  {
    ...
    "ranked": false,
    "activation": "Incidental",
    "description": "Once per game session, the character can choose to make one skill check using Intellect, rather than the characteristic linked to that skill. When [they] do this, [they] must explain how, in this particular instance, [their] intelligence is helping [them] overcome this challenge."
  },
  {
    "key": "STRONG",
    "name": "Strong Arm",
  ...
  },
  {
    ...
    "ranked": false,
    "activation": "Incidental",
    "description": "When making Melee checks, the character may choose to deal damage as strain instead of wounds. This does not ignore soak."
  },
  {
    "key": "STUNBLIMP",
  ...
  },
  {
    ...
    "ranked": true,
    "activation": "Passive",
    "description": "When this character makes a Medicine check to help a character heal wounds, the target heals one additional wound per rank of Surgeon."
  },
  {
    "key": "SURVFIT",
  ...
  },
  {
    ...
    "ranked": false,
    "activation": "Maneuver",
    "description": "The character may spend 1 Destiny point to perform a Move maneuver as an incidental to attempt to move into cover or out of the blast range of a weapon or explosion. This may be performed out of turn. This incidental occurs after the character determines he would be hit by the blast, but before damage is applied."
  },
  {
    "key": "TIME2GOIMP",
  ...
  },
  {
    ...
    "ranked": false,
    "activation": "Passive",
    "description": "Any vehicle the character pilots counts as having a silhouette one lower than normal when being attacked to a minimum of 0."
  },
  {
    "key": "TRUEAIM",
    "name": "True Aim",
  ...
  },
  {
    ...
    "ranked": true,
    "activation": "Passive",
    "description": "Force talent. The character adds a boost die per rank of Uncanny Reactions to [their] Vigilance checks."
  },
  {
    "key": "UNCANSENS",
    "name": "Uncanny Senses",
  ...
  },
  {
    ...
    "ranked": true,
    "activation": "Passive",
    "description": "When [they] sell legal goods to a reputable merchant or business, the character gains an additional 10% credits per rank of Wheel and Deal (based on the original selling price of the good or item)."
  },
  {
    "key": "WILLFORCE",
  ...
  },
  {
    ...
    "ranked": false,
    "activation": "Incidental",
    "description": "Once per round when making a combat check, the character may perform a Wise Warrior incidental to spend 1 Destiny Point and use any characteristic for the check."
  },
  {
    "key": "WISEWARIMP",
