...
window.SW.talents = [
  ...
  },
  {
    ...
    "ranked": true,
    "activation": "Passive",
    "description": "Whenever the character repairs system strain on a starship or vehicle, [they] repair one additional system strain per rank of Fine Tuning. The following is a homebrew expansion of this talent from a community-produced homebrew sourcebook!"
  },
  {
    "key": "FIRECON",
    "name": "Fire Control",
  ...
  },
  {
    ...
    "ranked": true,
    "activation": "Passive",
    "description": "At the beginning of each game session, the character gains credits equal to [their] ranks in Sound Investments times 100. How this money is earned is up to the player and GM, and could be actual investments, business dealings, or even a small legal or illegal side business. The GM can also decide that the current events of the adventure may make these funds unavailable. The following is a homebrew expansion of this talent from a community-produced homebrew sourcebook!"
  },
  {
    "key": "SPARECL",
    "name": "Spare Clip",
