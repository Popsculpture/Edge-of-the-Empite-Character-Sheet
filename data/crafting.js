...
window.SW.crafting = {
  ...
  categories: [
    ...
    // ── Ranged weapons ───────────────────────────────────────────────────
    {
      ...
      templates: [
        ...
        { key: 'CRAFT_MISSLAUNCH', name: 'Missile Launcher', price: 4000, rarity: 7, restricted: true, difficulty: 4, skills: ['Mechanics'], hours: 16,
          ...
          note: 'Uses the profile of whatever missile is loaded.',
          profile: { skillKey: 'GUNN', skill: 'Gunnery', damage: 0, damageType: 'base', crit: 0, range: 'Extreme', encumbrance: 7, hp: 4, qualities: [] } },
    ...
    // ── Lightsabers ──────────────────────────────────────────────────────
    {
      ...
      intro: 'A hilt is only half the weapon. Built empty it does no damage at all; fit a crystal and the blade comes with it.',
      note: 'Damage, Breach, and Sunder come from the crystal you install. The profiles below are the finished weapon with a standard crystal fitted.',
      templates: [
        { key: 'CRAFT_LS_STD', name: 'Standard Lightsaber', price: 100, rarity: 4, difficulty: 2, skills: ['Mechanics'], hours: 6,
          examples: 'Lightsaber',
          profile: { skillKey: 'LTSABER', skill: 'Lightsaber', damage: 6, damageType: 'base', crit: 2, range: 'Engaged', encumbrance: 1, hp: 5, hands: 'One-handed',
                     qualities: [{ key: 'BREACH', name: 'Breach', count: 1 }, { key: 'SUNDER', name: 'Sunder' }] } },
        { key: 'CRAFT_LS_PREC', name: 'Precision Lightsaber', price: 150, rarity: 5, difficulty: 2, skills: ['Mechanics'], hours: 12,
          examples: 'Shoto, dagger lightsaber, lightfoil',
          note: 'Installed crystals deal 1 less damage.',
          profile: { skillKey: 'LTSABER', skill: 'Lightsaber', damage: 5, damageType: 'base', crit: 2, range: 'Engaged', encumbrance: 1, hp: 3, hands: 'One-handed',
                     qualities: [{ key: 'ACCURATE', name: 'Accurate', count: 1 }, { key: 'BREACH', name: 'Breach', count: 1 }, { key: 'SUNDER', name: 'Sunder' }] } },
        { key: 'CRAFT_LS_DEF', name: 'Defensive Lightsaber', price: 300, rarity: 6, difficulty: 3, skills: ['Mechanics'], hours: 12,
          examples: 'Guard shoto',
          note: 'Installed crystals deal 1 less damage.',
          profile: { skillKey: 'LTSABER', skill: 'Lightsaber', damage: 5, damageType: 'base', crit: 2, range: 'Engaged', encumbrance: 1, hp: 3, hands: 'One-handed',
                     qualities: [{ key: 'DEFENSIVE', name: 'Defensive', count: 1 }, { key: 'BREACH', name: 'Breach', count: 1 }, { key: 'SUNDER', name: 'Sunder' }] } },
        { key: 'CRAFT_LS_DBL', name: 'Double-Bladed Lightsaber', price: 300, rarity: 5, difficulty: 3, skills: ['Mechanics'], hours: 12,
          examples: 'Double-bladed lightsaber, Temple Guard lightsaber pike',
          note: 'Attachments and crystals cost double.',
          profile: { skillKey: 'LTSABER', skill: 'Lightsaber', damage: 6, damageType: 'base', crit: 2, range: 'Engaged', encumbrance: 2, hp: 4, hands: 'Two-handed',
                     qualities: [{ key: 'BREACH', name: 'Breach', count: 1 }, { key: 'LINKED', name: 'Linked', count: 1 },
                                 { key: 'SUNDER', name: 'Sunder' }, { key: 'UNWIELDY', name: 'Unwieldy', count: 3 }] } },
        { key: 'CRAFT_LS_POLE', name: 'Pole Lightsaber', price: 150, rarity: 5, difficulty: 3, skills: ['Mechanics'], hours: 12,
          examples: 'Lightsaber pike, long-handle lightsaber',
          profile: { skillKey: 'LTSABER', skill: 'Lightsaber', damage: 6, damageType: 'base', crit: 2, range: 'Engaged', encumbrance: 2, hp: 4, hands: 'Two-handed',
                     qualities: [{ key: 'BREACH', name: 'Breach', count: 1 }, { key: 'CUMBERSOME', name: 'Cumbersome', count: 3 },
                                 { key: 'DEFENSIVE', name: 'Defensive', count: 1 }, { key: 'SUNDER', name: 'Sunder' }] } },
      ],
      improvements: [
        { adv: 1, options: [
          { name: 'Lightweight', text: 'Encumbrance -1, to a minimum of 1.' },
    ...
    // ── Cybernetics ──────────────────────────────────────────────────────
    {
      ...
      templates: [
        ...
        { key: 'CRAFT_CYB_APP', name: 'Cybernetic Appendage', price: 5000, rarity: 5, difficulty: 4, skills: ['Mechanics'], hours: 48,
          profile: { encumbrance: 0, charModNote: true,
